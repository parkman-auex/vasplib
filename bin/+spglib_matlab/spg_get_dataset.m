function SpglibDataset  = spg_get_dataset(POSCAR_name,symprec,spglib_path,spglib_include)
if nargin < 1
    POSCAR_name = 'POSCAR';
end
if nargin < 2 
...
rotation = reshape(rotationsPtr.Value,3,3,[]);
                 for i = 1:SpglibDataset.n_operations
                     rotation(:,:,i) =rotation(:,:,i).';
                 end
SpglibDataset.rotation  =    rotation ;
% transformation
...
SpglibDataset.translations  =    translations;
% wyckoffs
